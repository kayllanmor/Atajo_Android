...
public class SQLitePlugin extends CordovaPlugin
{
	...
	{
		Log.w("SQLLITE PLUGIN", "EXECUTE CALLED");
		try {
			boolean status = true;
	...
	public void onDestroy() {
		Log.w("SQLLITE PLUGIN", "ONDESTROY CALLED");
	...
	{
		Log.w("SQLLITE PLUGIN", "OPENDATABASE CALLED");
	...
	{
		Log.w("SQLLITE PLUGIN", "CLOSEDATABASE CALLED");

		SQLiteDatabase mydb = this.getDatabase(dbName);

		if (mydb != null)
		{
			Log.w("SQLLITE PLUGIN", "CLOSEDATABASE CALLED ON : "+dbName);
	...
	{
		Log.w("SQLLITE PLUGIN", "DELETEDATABASE CALLED");
	...
	{
		Log.w("SQLLITE PLUGIN", "GETDATABASE CALLED");
	...
	{
		Log.w("SQLLITE PLUGIN", "EXECUTESQLBATCHINBACKGROUND CALLED");
	...
	{
		Log.w("SQLLITE PLUGIN", "EXECUTESQLBATCH CALLED");
	...
	{
		Log.w("SQLLITE PLUGIN", "GETROWSRESULTFROMQUERY CALLED");
